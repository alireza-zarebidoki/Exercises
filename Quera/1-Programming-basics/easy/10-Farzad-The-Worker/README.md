# تمرین اول: فرزاد کارکن (Farzad the Worker)
...
واضح است که بیشترین سود شرکت در چهارمین روز بوده است، که برابر ۴ میلیون تومان است. چون مجموع اعضای هر زیرآرایه دیگری از این آرایه داده شده، مقداری کوچک‌تر از ۴ دارد. دقت کنید که اگر همه اعداد، منفی (ضرر) بودند، میزان سود برابر ۰ است. برنامه‌ای بنویسید که فرزاد به وسیله آن بدون محاسبات ذهنی، کار خود را انجام دهد.

### ورودی
در خط اول ورودی تعداد روزهایی که قرار است سود و ضرر محاسبه شود ($n$) و در ادامه آرایه‌ی سود و ضررها در این روزها گرفته می‌شود.
$$1 \le n \le 100$$
